...
Ext.define("PSO2.CostPanel", {
    ...
    changeOptionCost: function() {
        var c = this;
        for (var e in c.synthesisParams) {
            var a = Ext.getCmp(e),
                b = a.getResultPanel(),
    ...
    getAbilityRefferer: function(extendAbility) {
        ...
        for (var index = 0; index < baseLength; index++) {
            if (base[index].indexOf("*") < 0) {
                ...
                var codeHead = code.match(codeHeadCapture)
                ...
                var relTarget = abilitySet.getKeyList(hashStack).join(",").match(head[0]);
                if (relTarget) {
                    g = relTarget
                } else {
                    return null
        ...
        var abilityComponent = this,
            fodderSlot = Ext.create("Ext.data.Store", {
                ...
                chkFn: function(affix1, affix2) {
                    ...
                    excludePattern, match1, match2;
                    for (var i = 0;ix < excludePatterns.length;ix++) {
...
Ext.define("PSO2.SynthesisComponent", {
    ...
    findLocationHashBy: function(synPanel) {
        ...
        for (var index = 0; index < hashLen; index++) {
    ...
    updateLocationHash: function() {
        ...
        if (synComp.initializedRestoreData !== true && synComp.initializedCheckbox !== false && synComp.initializedSelectOption !== false) {
            if (0 < hashLen) {
                instanceHash = "#!";
                for (var index = 0; index < hashLen && index < synComp.limitUrlSize; index++) {
                    instanceHash += "/";
