...
Ext.define("PSO2.ResultPanel", {
    ...
    calcSameBonus: function(nameNrate, sameCount) {
        var resultPanel = this;
        return Math.min(parseInt(nameNrate.success * resultPanel.sameBonusBoost[PSO2.utils.overflow(resultPanel.sameBonusBoost.length, sameCount + 1, 1)]), 100)
    },
    initComponent: function() {
        var resultPanel = this;
    ...
    selectOption: function(a) {
        var resultPanel = this,
            b = resultPanel.prefixOptions[a.charAt(0)];
        if (b) {
            b.select(a)
        }
    },
    refresh: function() {
        var resultPanel = this,
            ...
            optItem1fn = resultPanel.getSelectOptionRecord(resultPanel.selOpt1).get("fn"),
            optItem3fn = resultPanel.getSelectOptionRecord(resultPanel.selOpt3).get("fn"),
        ...
        for (itemCount = 0; itemCount < resultPanel.successItems.length; itemCount++) {
            ...
            successRate = optItem1fn(successRate);
            successRate = optItem3fn(successRate);
    ...
    updateResults: function(selectionPanel) {
        ...
        codeNrate = resultPanel.abilityComponent.getSuccessList2(resultPanel.abilitySet, affixList);
        resultPanel.abilitySet.forEach(function(affixEntry, isSAF) {
            if (isSAF) {
                selectionPanel.add({
                ...
                if (codeNrate[affixEntry.code]) {
                    selectionPanel.add({
                        fieldStyle: "float:left",
                        boxLabel: '<p style="float:left;padding-left:3px">' + affixEntry.name + '</p><p style="float:right;padding-right:3px">' + codeNrate[affixEntry.code] + "%</p>",
                        inputValue: affixEntry.code,
                        abilityData: affixEntry,
                        resultPanel: resultPanel,
                        fieldSet: selectionPanel
