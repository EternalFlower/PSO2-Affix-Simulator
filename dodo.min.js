...
Ext.define("PSO2.GridGrouping", {
    ...
    getHeaderName: function(affixGroup) {
        if (affixGroup.name == "AA") {
        ...
        } else if (affixGroup.name == "BA") {
            return "Extreme"
        } else if (affixGroup.name == "BB") {
            return "Factor"
        } else if (affixGroup.name == "BC") {
            return "Reverie"
        } else if (affixGroup.name == "BD") {
            return "Mark"
        } else if (affixGroup.name == "BE") {
            return "Sentence"
        } else if (affixGroup.name == "BF") {
            return "Phrase"
            ...
            return "Fever"
        } else if (affixGroup.name == "GA") {
            return "Gifts"
        } else if (affixGroup.name == "GB") {
            return "Receptors"
        } else if (affixGroup.name == "WA") {
            return "Items"
        } else if (affixGroup.name == "YA") {
            return "Special"
        } else if (affixGroup.name == "L1") {
            return "Super Special Abilities 1"
        } else if (affixGroup.name == "L2") {
            return "Super Special Abilities 2"
        } else if (affixGroup.name == "L3") {
            return "Super Special Abilities 3"
        } else if (affixGroup.name == "L4") {
            return "Super Special Abilities 4"
        }
        return "Other"
    }
});
                ...
                handler: function() {
                    ...
                    Ext.create("widget.window", {
                        ...
                        items: [{
                            ...
                            '<b>4/12/2018:</b><br>- Added Loser Reverie<br>'+
                            '<br><b>4/5/2018:</b><br>- Added the changelog<br>'+
                            ...
                            '<br><b>6/7/2018:</b><br>- Added Lesser/EV<br>- Added new SSAs<br>- Fixed some bugs',
							//html: '<a href="https://twitter.com/share" class="twitter-share-button" data-url="' + h + '" data-text="PSO2 Skill Simulation"></a>',
                            listeners: {
                                single: true,
                                afterrender: function() {
