...
Ext.define("PSO2.AbilitySet", {
    ...
    put: function(ability) {
        ...
        if (Ext.isArray(ability.extend)) {
            if (0 < ability.extend[abilitySet.overflow(ability.extend.length, c, 1)] && Ext.Array.indexOf(d.stack, ability) < 0) {
...
Ext.define("PSO2.ResultPanel", {
    ...
    getSpecInfo: function(abilityList) {
        var resultPanel = this,
            ...
            outputText = "",
            index;
        for (index = 0; index < abilityListLen; index++) {
...
Ext.define("PSO2.GridGrouping", {
    ...
    getHeaderName: function(affixGroup) {
        ...
        } else if (affixGroup.name == "A+") {
            return "Stat Enhancement (Special)"
        } else if (affixGroup.name == "A++") {
            return "Special Ability Factor"
        } else if (affixGroup.name == "B") {
            return "Resistance"
        } else if (affixGroup.name == "C") {
            return "Status Effect"
        } else if (affixGroup.name == "D") {
            return "Soul"
        } else if (affixGroup.name == "D+") {
            return "Fever"
        } else if (affixGroup.name == "E") {
            return "Special"
        } else if (affixGroup.name == "L") {
                return "Super Special Abilities"
        } else if (affixGroup.name == "LOSS") {
