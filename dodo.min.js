...
Ext.define("PSO2.SynthesisComponent", {
    ...
    initGridMenuButton: function() {
        ...
        for (index = 0; index < synComp.maxMaterial; index++) {
            buttons.push({
                iconCls: "x-copy-icon",
                text: "",
                scope: synComp,
        ...
        var synPanel = synComp.tabPanel.add({
            ...
            fillDuster: function() {
                var gridPanels = this.query("gridpanel"),
                    index, maxSlots = 0;
                for (index = 0; index < gridPanels.length; index++) {
    ...
    createGridPanel: function(index, store, panel, codeString) {
        ...
        fodderPanel = Ext.create("Ext.grid.Panel", {
            ...
            sortableColumns: false,
            dustAbilities: synComp.ability.abilityStore.getRange(synComp.ability.abilityStore.find("gid", "F")),
            ...
            fillDuster: function(minAffix) {
                ...
                if (this.getAbilityCount() <= minAffix) {
                    ...
                    for (index = count = 0; count < minAffix; count++) {
    ...
    initializeSlotDropZone: function(inGridView) {
        ...
        gridPanel.dropZone = Ext.create("Ext.dd.DropZone", inGridView.el, {
            ...
            onNodeDrop: function(htmlCellEle, dragZone, event, gridView) {
                if (gridView.panel && gridView.panel.locked) {
                    return true
                }
                if (this.id == gridView.gridId) {
                    gridView.getStore().swapAbility(gridView.sourceEl.viewIndex, event.getTarget(gridView.itemSelector).viewIndex);
                    gridView.refresh();
                    synComp.onChangeAbility()
                } else {
                    gridView.getStore().addAbility(gridView.patientData)
                }
                return true
            }
        })
